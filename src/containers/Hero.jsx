...
const Hero = () => {
  return (
    <>
      <section className="w-full px-12 xl:px-6 md:px-3 font-primary">
        <div className="max-w-[1920px] max-h-[747px] w-calcLargest h-calcLargest flex flex-col items-center justify-center gap-y-8 bg-hero bg-cover bg-center bg-no-repeat xl:w-full lg:h-calcLarge md:h-calcMedium md:bg-heroMobile md:gap-y-4">
